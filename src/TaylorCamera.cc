...
double TaylorCamera::FindRootWithNewton(Vector<5> v5Coeffs, Vector<4> v4CoeffsDeriv, double dTanTheta, double dRhoInit, double dErrorLimit, int nMaxIter)
{
...
Vector<3> TaylorCamera::UnProject(const Vector<2>& v2ImFrame)
{
  ...
  //cout<<"-------------------------"<<mv2Center[0]<<"------------------------------"<<mv2Center[1]<<endl;
...
template<int Size, class Precision, class Base> double TaylorCamera::PolyVal(const Vector<Size, Precision, Base>& vxCoeff, double dEvalAt)
{
